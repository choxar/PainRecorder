...
class JournalTableViewController: UIViewController, NSFetchedResultsControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "itemCell", for: indexPath) as! JournalTableViewCell

        // Configure the cell...
        cell.dateLabel.text = records[indexPath.row].date
        cell.timeLabel.text = records[indexPath.row].time
        cell.painTypeLabel.text = records[indexPath.row].painType
        cell.painPowerLabel.text = records[indexPath.row].painPower
